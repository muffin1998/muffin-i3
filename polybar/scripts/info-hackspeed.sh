...
#################################################################################################################
#                                                                                                               #
#       code from https://github.com/polybar/polybar-scripts/tree/master/polybar-scripts/info-hackspeed        #
#                                                                                                               #
#################################################################################################################

# use 'xinput' to find your keyboard id
# use 'xinput test $KEYBOARD_ID' to test if the keyboard action can be catch
# for laptop keyboard, set KEYBOARD_ID='AT Translated Set 2 keyboard' should work
KEYBOARD_ID=13
